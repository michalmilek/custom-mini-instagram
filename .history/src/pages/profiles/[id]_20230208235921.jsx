...
const Page = ({ id }) => {
  ...
  return (
    <div className="flex flex-col items-center min-w-[100vw]">
        ...
        <section className="flex gap-5 items-center mt-5 bg-white border border-gray-200 drop-shadow-xl p-4">
          ...
          <article className="flex flex-col justify-center gap-4">
            <div className="flex gap-5">
              ...
              <button className="bg-gray-800 drop-shadow-2xl text-white px-3 py-1 rounded-lg">
                Edit profile
              </button>
      ...
      <section className="grid grid-cols-4 gap-10 w-[70%] items-center justify-center mt-16">
        {posts.map((post) => (
          <LazyLoadImage
            onClick={() => {
              setActivePhoto({
      ...
      {activePhoto && (
        <Modal
          ...
          className="fixed top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] bg-white border border-gray-200 drop-shadow-xl">
          <LazyLoadImage
            src={activePhoto.img}
            alt="img"
            effect="blur"
          ...
          {comments.length > 0 && (
            <div className="w-full px-4 overflow-y-scroll scrollbar-none flex flex-col">
