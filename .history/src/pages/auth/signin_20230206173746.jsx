          ...
          {Object.values(providers).map((provider) => (
            <div
              ...
              <button
                ...
                className={`${provider.name === "Google" && "bg-orange-600"} ${
                  provider.name === "GitHub" && "bg-gray-700"
                } ${
                  provider.name === "Facebook" && "bg-blue-600"
                } rounded-lg hover:opacity-70 transition-all text-white py-1 px-4 font-bold`}>
