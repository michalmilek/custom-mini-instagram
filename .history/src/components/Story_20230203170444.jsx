    ...
    <div className="box-border flex flex-col truncate flex-shrink-0 items-center justify-center h-30 w-24">
      <div className="relative">
        <LazyLoadImage
          ...
          } opacity-95 h-[70px] border-2 cursor-pointer border-orange-600 p-[2px] w-[70px] self-center rounded-full`}
        />
        {username === session.user.username && (
          <PlusIcon className="h-11 w-11 absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] text-white" />
        )}
      </div>
